...
class SamplerOutput:
    ...
    # [num_reqs, max_num_accepted_tree_nodes], tree speculative path only.
    accepted_tree_node_ids: torch.Tensor | None = None
...
@dataclass
class TreeDraftTokenIds:
    # [num_reqs]
    req_ids: list[str]
    # One speculative token tree per request.
    draft_token_trees: list[DraftTokenTree]
