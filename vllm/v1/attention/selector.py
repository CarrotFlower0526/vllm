...
def get_attn_backend(
    ...
    if (
        ...
        and speculative_config.residual_tree
        ...
        and not attn_selector_config.use_non_causal
    ):
        if backend is not AttentionBackendEnum.TRITON_ATTN:
            logger.info_once(
                "Using TRITON_ATTN because residual_tree requires tree "
                "attention masks."
            )
